...
Launches the unit test files in src/tests/unit

### `npm run unit:coverage`

Launches the unit test with coverage

### `npm run e2e`

Launches the e2e test files in src/tests/e2e in headless mode

### `npm run e2e:open`

Launches the e2e test files in src/tests/e2e in real browser
